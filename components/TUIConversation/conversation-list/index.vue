				...
				<div class="content">
					<div class="content-header">
						...
						<div class="middle-box">
							...
							<span v-else-if="conversation.type === 'GROUP' && conversation.groupAtInfoList && conversation.groupAtInfoList.length > 0" class="middle-box-at">
...
// #endif
onMounted(() => {
	const userSig = uni.getStorageSync('IM_token');
